...
class UnansweredQuestionCapture
{
    ...
    public function getPoliteFallbackMessage(string $reasonCategory): string
    {
        return match ($reasonCategory) {
            UnansweredQuestion::REASON_MISSING_TOOL => 
                'Todavía no puedo ayudarte con esa solicitud, pero estoy aprendiendo constantemente. '
                . '¿Quieres que te ayude con productos, tu carrito o pedidos?',
            
            UnansweredQuestion::REASON_UNSUPPORTED_REQUEST => 
                'No puedo ayudarte con eso en este momento, pero puedo ayudarte a buscar productos, '
                . 'gestionar tu carrito o revisar tus pedidos. ¿En qué puedo ayudarte?',
            
            UnansweredQuestion::REASON_TOOL_ERROR => 
                'Disculpa, encontré un problema al procesar tu solicitud. '
                . '¿Podrías intentarlo de nuevo o preguntarme algo diferente?',
            
            UnansweredQuestion::REASON_INSUFFICIENT_DATA => 
            ...
            default => 
                'Lo siento, no puedo ayudarte con eso ahora. '
                . '¿Quieres que te ayude con productos, tu carrito o pedidos?',
        };
    }
}
